export const EMPLOYER_CONTENT = {
  ...
  form: {
    ...
    steps: [
      ...
      { id: 'review', label: 'Review', index: 6 },
    ],
    generalSteps: [
      { id: 'general', label: 'General', index: 0 },
      { id: 'contact', label: 'Contact', index: 1 },
  ...
  planStep: {
    ...
    modalTitleAdd: 'Add Plan & Rates',
    modalTitleEdit: 'Edit Plan & Rates',
    modalDescriptionAdd: 'Configure plan details, effective dates, and rate tiers.',
    modalDescriptionEdit: 'Update plan details, effective dates, and rate tiers.',
    addedPlanHeading: 'ADDED PLANS',
    clickRowToEditHint: 'Click a plan row to view its rate tiers, or click Edit to update.',
    nestedRatesHeading: 'Configured Rate Tiers',
    noRatesForPlan: 'No rate tiers configured for this plan.',
    expandRatesAria: 'Expand rates for plan',
    collapseRatesAria: 'Collapse rates for plan',
    tableColumns: {
      plan: 'PLAN',
      groupNumber: 'GROUP NUMBER',
    ...
    emptyTable: 'No plans added yet. Click "Select Plan" above to configure a plan and its rates.',
  },
  rateStep: {
    heading: 'RATES',
    ...
    individualPlaceholder: '$000.00',
    parentChildLabel: 'Parent/Child',
    parentChildPlaceholder: '$000.00',
    parentChildrenLabel: 'Parent/Children',
    parentChildrenPlaceholder: '$000.00',
    memberSpouseLabel: 'Member Spouse',
    memberSpousePlaceholder: '$000.00',
    familyLabel: 'Family',
    familyPlaceholder: '$000.00',
    addButton: 'Add Rate',
