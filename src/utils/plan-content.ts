export const PLAN_CONTENT = {
  ...
  filters: {
    ...
    parentCompanyPlaceholder: 'All',
    carrierPlaceholder: 'All',
  },
  table: {
    emptyValue: '-',
    columns: {
  ...
  generalStep: {
    ...
    placeholders: {
      parentCompanySelect: 'Please select',
      ...
      commissionCodeSelect: 'Please select',
  ...
  validation: {
    ...
    optionRequired: 'Plan option is required',
    optionMax: 'Plan option must be 50 characters or fewer',
    nameRequired: 'Plan name is required',
    nameMax: 'Plan name must be 100 characters or fewer',
