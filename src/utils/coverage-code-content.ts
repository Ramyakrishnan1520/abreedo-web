export const COVERAGE_CODE_CONTENT = {
  ...
  form: {
    ...
    remittanceTypesLoadError: 'Failed to load remittance types. Please refresh.',
  ...
  validation: {
    ...
    combinationForBillMax: 'Combination for Bill must be 3 characters or fewer',
    combinationForReportsRequired: 'Combination for Reports is required',
    combinationForReportsMax:
      'Combination for Reports must be 3 characters or fewer',
    ...
    invoiceGroupRequired: 'Invoice Group is required',
    invoiceGroupMax: 'Invoice Group must be 100 characters or fewer',
    remittanceTypeRequired: 'Remittance Type is required',
  },
  toasts: {
