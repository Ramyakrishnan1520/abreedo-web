...
export interface CoverageCodeSelectItem {
  id: string
  code: string
  description?: string
}

interface CoverageCodeSearchSelectProps {
  id?: string
  options: CoverageCodeSelectItem[]
  value?: string
...
export function CoverageCodeSearchSelect({
  id,
  options,
  value,
  onValueChange,
  ...
  const triggerLabel = isLoading
    ? loadingPlaceholder
    : selectedItem
      ? `${selectedItem.code}${selectedItem.description ? ` - ${selectedItem.description}` : ''}`
      : placeholder
      ...
      <PopoverTrigger asChild>
        <Button
          ...
          className={cn(
            ...
            !selectedItem && !isLoading && 'text-muted-foreground',
          )}
        >
